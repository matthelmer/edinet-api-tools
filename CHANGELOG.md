...
- IFRS and US-GAAP filers whose highlight table discloses only a single combined equity line (no owners-of-parent / non-controlling-interest split) now populate net assets via the total-equity element instead of returning None.
