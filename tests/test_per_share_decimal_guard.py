"""A thousands separator in a per-share figure must yield an honest None, not
take down the whole annual-report parse. `coerce_numeric_value` keeps null
...
@pytest.mark.parametrize('raw,expected', [
    ...
    ('１２３４', Decimal('1234')),
    ('1,234', None),          # separator survives coercion; not a Decimal
    ('－', None), ('', None), (None, None),
])
